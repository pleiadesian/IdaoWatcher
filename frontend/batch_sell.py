...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_stock.setGeometry(QtCore.QRect(10, 50, 191, 41))
        font = QtGui.QFont()
        ...
        self.label_4.setGeometry(QtCore.QRect(250, 0, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.lineEdit_price = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_price.setGeometry(QtCore.QRect(330, 0, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lineEdit_price.setFont(font)
        self.lineEdit_price.setObjectName("lineEdit_price")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(410, 0, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.pushButton_delete = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_delete.setGeometry(QtCore.QRect(650, 40, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.label_6.setGeometry(QtCore.QRect(460, 60, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.lineEdit_percent = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_percent.setGeometry(QtCore.QRect(530, 60, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
